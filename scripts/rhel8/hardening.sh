...
case $HARDENING_FLAG in
  ...
  e8)
    oscap_generate_fix "/usr/share/xml/scap/ssg/content/ssg-rhel8-ds.xml" "xccdf_org.ssgproject.content_profile_e8"
    ;;

  hipaa)
    oscap_generate_fix "/usr/share/xml/scap/ssg/content/ssg-rhel8-ds.xml" "xccdf_org.ssgproject.content_profile_hipaa"
    ;;

  ospp)
    oscap_generate_fix "/usr/share/xml/scap/ssg/content/ssg-rhel8-ds.xml" "xccdf_org.ssgproject.content_profile_ospp"
    ;;

  pci-dss)
    oscap_generate_fix "/usr/share/xml/scap/ssg/content/ssg-rhel8-ds.xml" "xccdf_org.ssgproject.content_profile_pci-dss"
    ;;
